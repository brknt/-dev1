...
let allCategory = menu.map((item) => item.category);//kategorilerin hepsini ekle
let categories = [...new Set(allCategory)];//Her kategoriyi birkere ekle
categories.unshift("All");//dizi başına All ekle
